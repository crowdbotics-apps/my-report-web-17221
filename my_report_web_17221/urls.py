"""my_report_web_17221 URL Configuration
...
admin.site.site_header = "My Report Web"
admin.site.site_title = "My Report Web Admin Portal"
admin.site.index_title = "My Report Web Admin"

# swagger
schema_view = get_schema_view(
    openapi.Info(
        title="My Report Web API",
        default_version="v1",
        description="API documentation for My Report Web App",
    ),
    public=True,
